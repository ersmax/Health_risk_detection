...
- images/fig2_wrist_IMU.png — example wrist‑IMU used in literature (Bochniewicz et al. style)
- images/fig3_foot_IMU.png  — foot IMU / acceleration visualization (Zhou et al. style)
- images/fig4_four_limb_IMUs.png — four‑limb accelerometer layout (Lucas et al. style)
- images/pca_variance.png — PCA variance figure (already present)
- images/acceleration_magnitude.png — example time‑domain acceleration magnitude (from notebook)
- images/ROC_FAC.png, images/ROC_FFP.png, images/global_importance_gb_FFP_AllSensors.png, images/SHAP_feature_impact–probability_of_being_Frail.png — SHAP / ROC / importance figures (generated by notebooks)

Note: add the three literature images (fig2/fig3/fig4) to the images/ folder before publishing if you want inline figures in the README. Use clear captions and cite original sources in the thesis and GitHub repo.
